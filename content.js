...
if(request.comments)
{
	...
	button_div.className = "button_containter";


	button_div.append(commentreplysubmit);
	...
	let comments_from_dom_array = [];
	let comments_from_dom = document.querySelectorAll('[class="docos-replyview-body docos-anchoredreplyview-body"]');
	comments_from_dom;
		comments_from_dom.forEach(i => {        
        //console.log(i);
        //console.log(i.parentNode);
		comments_from_dom_array.push(i.textContent);	
	})
	request.comments = comments_from_dom_array;
